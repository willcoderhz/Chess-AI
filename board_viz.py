# Board visualization with ipywidgets͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
import copy
...
class ReplayGame():
    ...
    def show_board(self):
        # Show slider for move selection͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        #Left side͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        grid[:3, :-3] = self.gridb
        grid[3, :-3] = slider

        #Right side͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
