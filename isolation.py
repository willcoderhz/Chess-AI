...
import time
import platform
# import io͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
from io import StringIO

# import resource͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
...
class Board:
    ...
    def set_state(self, board_state, p1_turn=True):
        ...
        if last_move_k1 != []:
            # set last move to the first found occurance of 'K1'͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        # Count X's to get move count + 2 for initial moves͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        self.move_count = sum(row.count('X') + row.count('K1') + row.count('K2') for row in board_state)

    #function to edit to introduce any variant - edited for Knight isolation variant by Nick Shu (05/24)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    def __apply_move__(self, knight_move):
        ...
        '''
        # print("Applying move:: ", knight_move)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        row, col = knight_move
        my_pos = self.__last_knight_move__[self.__active_players_knight__]
        #opponent_pos = self.__last_knight_move__[self.__inactive_players_knight__]͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁

        ######Change the following lines to introduce any variant######͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        if my_pos != Board.NOT_MOVED:
            self.__board_state__[my_pos[0]][my_pos[1]] = Board.BLOCKED

            #check if player moves more than 1 space in any direction͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
            # if abs(col - my_pos[0]) > 1 or abs(row - my_pos[1]) > 1:͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
            #     self.__create_crater__(knight_move)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
       ######Change above lines to introduce any variant######͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁

        # apply move of active player͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        # increment move count͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        self.move_count = self.move_count + 1

        # If opponent is isolated͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    ...
    def knight(self, move):
        ...
        # Obtaining the moves clockwise͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    ...
    def play_isolation(self, time_limit=10000, print_moves=False):
        ...
        while True:
            ...
            def time_left():
                # print("Limit: "+str(time_limit) +" - "+str(curr_time_millis()-move_start))͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
            ...
            # Append new move to game history͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
            ...
            # Handle Timeout͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
            ...
            if is_over:
                ...
                # if not self.get_active_moves():͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
                #     return self.__active_players_knight__, move_history, \͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
                #            (self.__inactive_players_knight__ + " has no legal moves left.")͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
                # return self.__active_players_knight__, move_history, \͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
                #        (self.__inactive_players_knight__ + " was forced off the grid.")͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
